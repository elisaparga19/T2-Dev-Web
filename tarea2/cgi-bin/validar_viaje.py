...
name = 'Agregar Viaje'
title = 'AGREGAR VIAJE'
inicio_form = """<form id="agregarViaje" action="https://anakena.dcc.uchile.cl/~cc500210/cgi-bin/tarea-2/cgi-bin/validar_viaje.py" method="POST" enctype="multipart/form-data">"""
