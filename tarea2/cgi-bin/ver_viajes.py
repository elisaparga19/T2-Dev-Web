...
nav_bar = f"""<nav>
                <ul class="pagination">
                    <li class="page-item {disable_previous(counter)}"><a class="page-link" href="https://anakena.dcc.uchile.cl/~cc500210/cgi-bin/tarea-2/cgi-bin/ver_viajes.py?action=previous&counter={counter}">Previous</a></li>
                    <li class="page-item {disable_next(database, 'viaje', counter)}"><a class="page-link" href="https://anakena.dcc.uchile.cl/~cc500210/cgi-bin/tarea-2/cgi-bin/ver_viajes.py?action=next&counter={counter}">Next</a></li>
                </ul>
            </nav>"""

def generate_row_from_element(viaje):
    row = f"""
        <tr id={viaje[0]} data-href="https://anakena.dcc.uchile.cl/~cc500210/cgi-bin/tarea-2/cgi-bin/informacion_viaje.py?id={viaje[0]}">
