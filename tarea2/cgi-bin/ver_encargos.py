...
nav_bar = f"""<nav>
                <ul class="pagination">
                    <li class="page-item {disable_previous(counter)}"><a class="page-link" href="https://anakena.dcc.uchile.cl/~cc500210/cgi-bin/tarea-2/cgi-bin/ver_encargos.py?action=previous&counter={counter}">Previous</a></li>
                    <li class="page-item {disable_next(database, 'encargo', counter)}"><a class="page-link" href="https://anakena.dcc.uchile.cl/~cc500210/cgi-bin/tarea-2/cgi-bin/ver_encargos.py?action=next&counter={counter}">Next</a></li>
                </ul>
            </nav>"""
...
def generate_row_from_element(encargo):
    id = encargo[0]
    row = f"""
        <tr id={id} data-href="https://anakena.dcc.uchile.cl/~cc500210/cgi-bin/tarea-2/cgi-bin/informacion_encargo.py?id={id}">
